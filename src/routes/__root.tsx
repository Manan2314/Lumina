...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lumina · Where Ambition Meets Direction" },
      {
        name: "description",
        content:
          "Lumina helps professionals and lifelong learners discover the academic pathway best aligned with their experience, qualifications, and ambitions.",
      },
